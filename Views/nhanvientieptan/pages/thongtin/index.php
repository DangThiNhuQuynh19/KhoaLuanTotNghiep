        ...
        <div class="info-grid">
            ...
            <div class="info-section">
                ...
                <table class="info-table">
                    ...
                    <tr>
                        <th>Email cá nhân:</th>
                        <td><?=htmlspecialchars(isset($nv['emailcanhan']) ? decryptData($nv['emailcanhan']) : "") ?></td>
                    </tr>
                    <tr>
                        <th>Số điện thoại:</th>
            ...
            <div class="info-section">
                ...
                <table class="info-table">
                    ...
                    <tr>
                        <th>Ngày kết thúc:</th>
                        <td><?= htmlspecialchars(isset($nv['ngayketthuc']) ? $nv['ngayketthuc']: "") ?></td>
                    </tr>
                    <tr>
                        <th>Chức vụ:</th>
                    ...
                    <tr>
                        ...
                        <td><?= htmlspecialchars(htmlspecialchars(isset($nv['tentrangthai']) ?$nv['tentrangthai'] : "")) ?></td>
                    </tr>
                </table>
            </div>
        </div>
