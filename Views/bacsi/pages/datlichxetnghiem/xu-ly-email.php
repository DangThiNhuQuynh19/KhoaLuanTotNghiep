...
class XuLyEmail {
    ...
    public function gui_email_yeu_cau_thanh_toan($email_benh_nhan, $ten_benh_nhan, $ten_xet_nghiem, $ngay_hen, $gio_hen, $ma_lich_hen) {
    ...
    private function tao_ma_bao_mat($ma_lich_hen) {
        $chuoi_bi_mat = "BENH_VIEN_HANH_PHUC_2024";
        return hash('sha256', $ma_lich_hen . $chuoi_bi_mat . time());
    }
    
    private function tao_noi_dung_email_html($ten_benh_nhan, $ten_xet_nghiem, $ngay_hen, $gio_hen, $ma_lich_hen, $link_thanh_toan) {
        return "
        <!DOCTYPE html>
        <html lang='vi'>
        <head>
        ...
        <body>
            <div class='container'>
                ...
                <div class='content'>
                    ...
                    <p>Chúng tôi đã nhận được yêu cầu đặt lịch xét nghiệm của bạn. Để hoàn tất việc đặt lịch, vui lòng thanh toán trong vòng <strong>30 phút</strong>.</p>
                    
                    <div class='info-box'>
                        <h3>📋 Thông Tin Lịch Hẹn</h3>
                        <p><strong>Mã lịch hẹn:</strong> #{$ma_lich_hen}</p>
                        <p><strong>Loại xét nghiệm:</strong> {$ten_xet_nghiem}</p>
