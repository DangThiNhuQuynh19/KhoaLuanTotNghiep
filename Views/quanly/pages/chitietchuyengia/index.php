...
<div class="container">
    <a href="?action=nhanvien&tab=chuyengia" class="btn btn-secondary mb-3">← Quay lại</a>
    ...
    <div class="doctor-header">
        ...
        <div class="doctor-info">
            ...
            <p><strong>Chuyên khoa:</strong> <?php echo htmlspecialchars($row['tenlinhvuc']); ?></p>
            <p><strong>Giá khám:</strong> <?php echo number_format($row['giatuvan']); ?> VNĐ</p>
