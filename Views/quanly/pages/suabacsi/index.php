...
<head>
    ...
    <style>
        ...
        /* eplaced table layout with card and form sections */
        .card {
            background: var(--card);
            border-radius: 12px;
    ...
    <div class="main-container">
        ...
        <?php if (isset($_GET['status']) && $_GET['status'] === 'success'): ?>
            <div class="alert alert-success">
                <span>✅ Cập nhật thông tin bác sĩ thành công!</span>
            ...
            <form method="post" action="">
                ...
                <div class="header-section">
                    <div class="avatar-box">
                        <img src="Assets/img/<?= htmlspecialchars($row['imgbs'] ?? 'default.png') ?>" alt="Avatar <?= htmlspecialchars($row['hoten']) ?>">
                    </div>
                    <div class="info-box">
                        <h3><?= htmlspecialchars($row['hoten']) ?></h3>
                        <p><i class="bi bi-person-badge"></i> <?= htmlspecialchars($row['capbac']) ?></p>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <select name="machuyenkhoa" class="form-control" required>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid full">
                        <div class="form-group">
                            <label class="form-label">Mô tả bác sĩ</label>
                            <textarea name="motabs" class="form-control" placeholder="Nhập mô tả chi tiết..."><?= htmlspecialchars($row['motabs']) ?></textarea>
                        </div>
                    </div>
                    <div class="form-grid full" style="margin-top: 1rem;">
                        <div class="form-group">
                            <label class="form-label">Giới thiệu</label>
                            <textarea name="gioithieubs" class="form-control" placeholder="Nhập giới thiệu chi tiết..."><?= htmlspecialchars($row['gioithieubs']) ?></textarea>
                        </div>
                    </div>
                </div>
