...
// Get or create hoso for this patient and expert
$hoso_list = $chosobenhandientu->get_mahoso_by_benhnhan_machuyengia($mabenhnhan, $chuyengia['machuyengia']);
$mahoso = null;
...
if($hoso_list && is_array($hoso_list) && count($hoso_list) > 0){
    ...
    if($chosobenhandientu->create_hosobenhandientu_mabenhnhan($mabenhnhan, $chuyengia['machuyengia'])){
...
if(isset($_POST['hoantat_kham'])){
    if($mahoso){
        ...
        if($cchitiethoso->create_chitiethoso($mahoso, $chuyengia['machuyengia'], $trieuchung, $chuandoan, $huongdieutri, null, $ketluan)){
