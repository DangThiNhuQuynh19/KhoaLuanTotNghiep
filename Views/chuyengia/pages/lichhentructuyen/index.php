...
$lichkham_list = $cphieukhambenh->get_lichkhamonl_machuyengia($chuyengia['machuyengia']);
...
if(isset($_POST["btntimkiem"])){
    ...
    $ngay = $_POST["ngay"];
    $lichkham_list = $cphieukhambenh->search_phieukhamonlcg($tukhoa, $trangthai, $ngay, $chuyengia['machuyengia']);
}

// Nếu nhấn Bỏ tìm kiếm, reset
