<?php
    ...
    $benhnhan_list= $cbenhnhan->get_benhnhan_machuyengia( $chuyengia['machuyengia']);

    if(isset($_POST["btntimkiem"])){
        $benhnhan_list = $cbenhnhan->get_benhnhan_tukhoa($_POST["tukhoa"], $chuyengia['machuyengia']);
    }

    if(isset($_POST['homnay'])){
        $benhnhan_list = $cbenhnhan->get_benhnhan_homnay($chuyengia['machuyengia']);
    }
